'-------------------------------------------------------------------------------------
' Title:		SKA_013_Storno_Sollbuchungen_im_KtoRahmen_92_bis_98_oberhalb_NAGrenze
' CIR:		SKA
' Customer:	Sparkassen
' Created by:	KKR
...
Dim dbStornoSollAufSollKto92To98 As String
...
'	Set db = Client.OpenDatabase("dbUmsaetzeOBRManuell")
	...
	dbStornoSollAufSollKto92To98 = oSC.UniqueFileName(sAuditFolder & "@SK-FuR-0013_StornoSollBuchungen_im_KtoRahmen_92_bis_98_Nichtaufgriffsgrenze.IMD")
	'task.AddExtraction dbStornoSollAufSollKto92To98, "", "(RAHMENNR_2STELLIG == ""92"" .OR. RAHMENNR_2STELLIG == ""93"" .OR. RAHMENNR_2STELLIG == ""94"" .OR. RAHMENNR_2STELLIG == ""95"" .OR. RAHMENNR_2STELLIG == ""96"" .OR. RAHMENNR_2STELLIG == ""97"" .OR. RAHMENNR_2STELLIG == ""98"" .OR. @isini(""Storno"";VERWENDUNGSZWECK)  .OR. @isini(""Korrektur"";VERWENDUNGSZWECK)  .OR.  @isini(""Berichtigung"";VERWENDUNGSZWECK) ) .AND. RELEVANT == ""X"""
	task.AddExtraction dbStornoSollAufSollKto92To98, "", "@match(RAHMENNR_2STELLIG;""92"";""93"";""94"";""95"";""96"";""97"";""98"") .AND. RELEVANT == ""X""" & sPositionEqn
...
'	Set oResultFile = oSC.CreateResultObject(dbName, FINAL_RESULT, True, 1)
	Set oResultFile = oSC.CreateResultObject(dbStornoSollAufSollKto92To98, FINAL_RESULT, True, 2)
...
' Amount of rows which should be shown in the report
	...
	Call SetFlagForTable(dbStornoSollAufSollKto92To98, TRUE)
	
	If bPrivateMode = TRUE Then
		' Remove History in files created by Analysis
		If oSC.FileExists(dbStornoSollAufSollKto92To98, "") Then oProtectIP.RemoveHistory dbStornoSollAufSollKto92To98
	End If
