...
'	Set db = Client.OpenDatabase("dbUmsaetzeOBRManuell")
	...
	dbUmsaetzeNichtPJahr = "-SK-FuR-0002_Umsätze_manuell_Wertstellung_nicht_im_Prüfjahr.IMD"
	eqn = "WERTSTELLUNG_JAHR <>" & """" & sGJahr & """"
	...
	dbUmsaetzeNichtPJahr = "-SK-FuR-0002_Umsätze_manuell_Wertstellung_nicht_im_Prüfjahr_summiert.IMD"
...
'	Set db = Client.OpenDatabase("dbUmsaetzeOBRManuell")
	...
	Set task = db.Extraction
	task.IncludeAllFields
	dbRelUmsaetzeNichtPJahr = "@SK-FuR-0019_Umsätze_manuell_Wertstellung_nicht_im_Prüfjahr_und_größer_Nichtaufgriffsgrenze.IMD"
	eqn = "RELEVANT <> """" .AND. WERTSTELLUNG_JAHR <>" & """" & sGJahr & """"
