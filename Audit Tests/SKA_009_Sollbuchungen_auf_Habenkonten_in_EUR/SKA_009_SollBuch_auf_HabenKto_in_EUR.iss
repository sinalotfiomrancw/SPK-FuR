'-------------------------------------------------------------------------------------
' Title:		SKA_009_Sollbuchungen_auf_Habenkonten_in_EUR
' CIR:		SKA
' Customer:	Sparkassen
' Created by:	KKR
...
'	Set db = Client.OpenDatabase("dbUmsaetzeOBRManuell")
	...
	dbSollAufHabenSummiert = "-SK-FuR-0009_SollBuchungen_auf_HabenKonten_summiert_in_EUR.IMD"
	...
	If db.Count > 0 Then
		...
		task.DisableProgressNotification = True
		dbSollAufHabenSummiert = "@SK-FuR_0009_SollBuchungen_auf_HabenKonten_in_EUR.IMD"
